...
public class CatControl : MonoBehaviour, IHost
{
	[HideInInspector]
	...
	public CatVisionController visionController;
	...
	public void TakeControl(ParasiteControl parasite)
	{
		...
		// Show cat vision objects.
		visionController.setCatObjectVisibility(true);
	}
